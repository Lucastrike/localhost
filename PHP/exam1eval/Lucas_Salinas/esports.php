            ...
            <div class="container-fluid">
              ...
              <div class="col-md-12">
                <div class="panel panel-default">
                  <div class="panel-heading">Esports</div>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">Insertar nou esport</h4>
					</div>
					<form action="insert_esport.php" method="post" id="formSingIn">
					<div class="modal-body">
						<input type="text" class="form-control" name="cod_esport" placeholder="cod_esport">
						<input type="text" class="form-control" name="esport" placeholder="esport">
                            ...
                            <tr>
                              ...
                              <td><?php echo $row['preu']; ?></td>
          										<td>
          											...
          											<a href="edit_esports.php?funcion=delete&id=<?php echo $row['cod_esport'];?>" class="btn btn-danger" type="button" name="deleteId">Delete</a>
          										</td>
                            </tr>
                            <?php } ?>
                    ...
                    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="myModalLabel">Modificar esports</h4>
                          </div>
                          <form action="edit_esports.php" method="post">
                          <div class="modal-body">
                              <input type="text" class="form-control" id="cod_esport" name="cod_esport" placeholder="cod_esport" readonly>
                              <input type="text" class="form-control" id="esport" name="esport" placeholder="esport">

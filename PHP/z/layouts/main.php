...
<head>
    ...
    <style>
            body {
        background-image: url(https://i.imgur.com/k9ZuNMH.jpg);
      }
...
<?php $this->beginBody() ?>
    ...
    <div class="address-bar">Some Inspirational Quote Here | 123.456.7890</div>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12 text-center">
                    <div id="carousel-example-generic" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img class="img-responsive img-full" src="https://i.imgur.com/1TwAKR6.jpg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="https://i.imgur.com/tVLatTQ.png" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="https://i.imgur.com/IZZuH5W.png" alt="">
                            </div>
                        </div>
                    ...
                    <h1 class="brand-name">My Application</h1>
                    <hr class="tagline-divider">
                    <h2>
                        <small>By
                            <strong>ThemeFactory.net</strong>
                        </small>
                    </h2>
                </div>
            </div>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <hr>
                    <img class="img-responsive img-border img-left" src="https://i.imgur.com/7uvL5nR.jpg" alt="">
                    <hr class="visible-xs">
